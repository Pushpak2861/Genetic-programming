...
def crossover_twopoint(parent0, parent1, bnf_grammar, max_depth, codon_consumption, 
                       genome_representation='list', max_genome_length=None):
    """
    ...
    while continue_:
        #Set points for crossover within the effective part of the genomes
        # do the minimum check
        point0 = random.randint(1, possible_crossover_codons0)
        point1 = random.randint(1, possible_crossover_codons1)
        point2 = random.randint(1, possible_crossover_codons0-1)
        point3 = random.randint(1, possible_crossover_codons1-1)
        ...
        if genome_representation == 'list':
            #Operate crossover
            new_genome0 = parent0_genome[0:point0] + parent1_genome[point1:point3] + parent0_genome[point2:]
            new_genome1 = parent1_genome[0:point1] + parent0_genome[point0:point2] + parent1_genome[point3:]
        else:
            raise ValueError("Only 'list' representation is implemented")
